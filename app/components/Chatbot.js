...
function Chatbot() {
  ...
  return (
    <>
      <div className="h-[70vh] chatbot shadow-gray-700 border-2 border-gray-600 mx-auto bg-gray-700 w-72 my-10 rounded-lg shadow-md fixed top-16 right-20 max-md:top-16 max-md:left-10 z-5">
